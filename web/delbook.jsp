...
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-5  col-md-12 contentLeft contentLeft-border gap">
      <div class="alert alert-primary text-center">请查询要删除的图书</div>
      <form id="formFind">
...
<script type="text/javascript">
    ...
    function createDiv(bookId, bookName, author, price, ps) {
        var DIV = "<div class=\"col-md-6 col-sm-12\">" +
            ...
            "          <input type=\"checkbox\" class=\"custom-control-input invisible\"  name=\"del_checkbox\" value=\"" + bookId + "\">\n" +
            "          <div class=\"card-body \">\n" +
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                if(result === "true"){
                    ...
                    $("#resultInfo")[0].innerHTML = "删除图书成功!";
                }else if(result === "false"){
                    $("#resultInfo").removeClass("alert-secondary");
                    $("#resultInfo").addClass("alert-danger");
                    $("#resultInfo")[0].innerHTML = "删除图书失败，该书还有读者未归还!";
                }
            }
        });
    }
